...
if __name__ == "__main__":
    ...
    parser.add_argument('--extension', help='file extension name', type=str, default="flac")
    parser.add_argument('--data_dir', help='dataset dir', type=str, default="CN-Celeb/CN-Celeb2_flac/data")
